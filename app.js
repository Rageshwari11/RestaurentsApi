...
var app = express();
var port = process.env.PORT || 9805;
var mongo = require('mongodb');
bodParser = require('body-parser');
var MongoClient = mongo.MongoClient
var mongourl = "mongodb+srv://admin:little123@cluster0.8eac1.mongodb.net/edurekainternship?retryWrites=true&w=majority";
...
app.get('/',(req,res) => {
    res.send(`<a href="http://localhost:9805/location" target="_blank">City</a> <br/> <a href="http://localhost:9805/mealtype" target="_blank">MealType</a> <br/> <a href="http://localhost:9805/cuisine" target="_blank">Cuisine</a> <br/> <a href="http://localhost:9805/restaurents" target="_blank">Restaurents</a> <br/> <a href="http://localhost:9805/orders" target="_blank">Orders</a>`)
})
